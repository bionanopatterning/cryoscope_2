...
int led1 = 3; // 405 nm - A - arduino pin 3
int led2 = 4; // 488 nm - B - arduino pin 4
int led3 = 7; // 561 nm - C - arduino pin 7 - no sync pin on this one.
...
void snap()
{
  ...
  while ((millis() - startTime) < exposureTime)
  {
      if (led3on)
      {
        if (digitalRead(pco_4) == 1)
        {
